                ...
                <>
                  ...
                  <section className="panel">
                    ...
                    {investigationGroup !== 'all' &&
                      investigationCount > 1000 && (
                        <p className="muted">
                          Scoped investigations support up to 1,000 units.
                          Choose All inventory to include this group.
                        </p>
                      )}
                    {!data?.health.keyConfigured && (
                      <div className="notice warning">
              ...
              {screen === 'monitoring' && (
                <>
                  ...
                  <div className="notice">
                    <Provenance label="CONTROLLED_DEMO_FIXTURE" />
                    <p>
                      The test notice first excludes MON-001. Version B includes
                      its serial and adds a required batch. The missing batch
                      sends the sample to review. This notice is synthetic.
                    </p>
                  </div>
                  <section className="panel">
